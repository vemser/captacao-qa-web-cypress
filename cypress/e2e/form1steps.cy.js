...
describe('Testes da primeira etapa do formulário de inscrição do Vem Ser', () => {
  ...
  it('Test 7 - Validar preenchimento de campos com nome contendo caractere especial', () => {
    const dados = cadastro()
  ...
  it('Test 8 - Validar preenchimento de campos com sem preencher telefone', () => {
    const dados = cadastro()
    dados.telefone = ""
  ...
  it('Test 9 - Validar preenchimento de campos com nome maior que 50 letras', () => {
    const dados = cadastro()
  ...
  it('Test 10 - Validar preenchimento de campos com rg invalido', () => {
    const dados = cadastro()
  ...
  it('Test 11 - Validar preenchimento de campos com cidade maior que 50 caracteres', () => {
    const dados = cadastro()
  ...
  it('Test 12 - Validar preenchimento de campos com rg vazio', () => {
    const dados = cadastro()
    dados.rg = ""
  ...
  it('Test 13 - Validar preenchimento de campos com email inválio', () => {
    const dados = cadastro()
  ...
  it('Test 14 - Validar preenchimento de campos com email vazio', () => {
    const dados = cadastro()
    dados.email = ""
  ...
  it('Test 15 - Validar preenchimento de campos com nome vazio', () => {
    const dados = cadastro()
    dados.nome = ""
  ...
  it('Test 16 - Validar preenchimento de campos com cidade vazio', () => {
    const dados = cadastro()
    dados.cidade = ""
  ...
  it('Test 17 - Validar preenchimento de campos com cpf vazio', () => {
    const dados = cadastro()
    dados.cpf = ""
