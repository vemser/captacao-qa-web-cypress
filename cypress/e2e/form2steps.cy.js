...
describe(' Form 2 Steps', () => {
    ...
    it.only('Test 3 - Validar Preenchimento sem preencher curso', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
      cy.preencherTodosCamposComSucesso2()
    ...
    it.only('Test 4 - Validar Preenchimento sem responder a pergunta: Por qual o outro motivo voce se interessou ela area de tecnologia?', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
      cy.preencherTodosCamposComSucesso2()
    ...
    it.only('Test 5 - Validar Preenchimento sem responder a pergunta: Alguem te ensinou algo importante...?', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
      cy.preencherTodosCamposComSucesso2()
    ...
    it.only('Test 6 - Validar sem selecionar a linguagem', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
    ...
    it.only('Test 7 - Validar sem selecionar a trilha', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
    ...
    it.only('Test 9 - Validar sem adicionar print configuração computador', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
    ...
    it.only('Test 10 - Validar sem selecionar: Você concorda com o tratamento dos seus dados pessoais...', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
    ...
    it.only('Test 11 - Validar selecionando a matriculado em curso de graducao: nao', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
    ...
    it.only('Test 12 - Validar sem selecionando nenhum nivel de ingles', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
    ...
    it.only('Test 13 - Validar sem selecionando nenhum nivel de espanhol', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
    ...
    it.only('Test 16 - Validar preenchendo numero no campo instituicao', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
    ...
    it.only('Test 17 - Validar preenchendo instituicao mais de 80 caracteres', () => {
      cy.preencherTodosCamposComSucesso()
      cy.clicarEmProximo()
